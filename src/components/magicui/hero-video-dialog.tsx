    ...
    <div className={cn("relative", className)}>
      ...
      >
        <Image
          src={thumbnailSrc}
          alt={thumbnailAlt}
          className="w-screen h-[500px] transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-xl shadow-lg object-cover bg-gradient-to-t from-[#0D105E99]/60 to-[#3B30B499]/60"
        />
        <div className="absolute inset-0 flex items-center justify-center group-hover:scale-100 scale-[0.9] transition-all duration-200 ease-out rounded-2xl">
          <div className="bg-slate-900/40 flex items-center justify-center rounded-full backdrop-blur-md size-28 dark:bg-slate-50/10">
            <div
