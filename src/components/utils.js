...
// Function to parse the rich text and convert it to HTML
export const richTextReducer = async (contentArray) => {
  ...
  let styledRichText = parsedRichText
    ...
    .replace(/<a /g, "<a style='color:inherit; text-decoration:underline;' ")  // Ensure links are styled properly (not blue)
    ...
    .replace(/<strong>/g, "<strong style='font-weight:bold;'>"); // Ensuring bold text is emphasized
